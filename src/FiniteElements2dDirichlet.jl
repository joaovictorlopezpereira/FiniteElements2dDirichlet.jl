...
# Arguments
- `Nx1::Integer`: the number of elements in the x axis.
- `Nx2::Integer`: the number of elements in the y axis.
...
"""
    solve_system(alpha, beta, f, Nx1, Nx2; EQLG=false, XY_matrix=false, noise=false)
...
Return the errors for the error convergency analysis.
...
"""
    init_mesh(Nx1, Nx2; ns=false, plot=false)
